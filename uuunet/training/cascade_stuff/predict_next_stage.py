...
import argparse
from uuunet.preprocessing.preprocessing import resample_data_or_seg
from batchgenerators.utilities.file_and_folder_operations import maybe_mkdir_p
import uuunet
from uuunet.run.default_configuration import get_default_configuration
from multiprocessing import Pool

from uuunet.training.model_restore import recursive_find_trainer
...
if __name__ == "__main__":
    ...
    trainer_class = recursive_find_trainer([join(uuunet.__path__[0], "training", "network_training")], trainerclass,
                                           "uuunet.training.network_training")
    
    if trainer_class is None:
        raise RuntimeError("Could not find trainer class in uuunet.training.network_training")
    else:
