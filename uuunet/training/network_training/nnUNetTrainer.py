import matplotlib
from uuunet.training.network_training.network_trainer import NetworkTrainer
...
from uuunet.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset
from uuunet.training.loss_functions.dice_loss import DC_and_CE_loss
...
from uuunet.training.data_augmentation.default_data_augmentation import default_3D_augmentation_params, \
...
from uuunet.evaluation.metrics import ConfusionMatrix
...
class nnUNetTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        self.num_input_channels = self.num_classes = self.net_pool_per_axis = self.patch_size = self.batch_size = None
        self.threeD = self.base_num_features = self.intensity_properties = self.normalization_schemes = None
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        # Hahaha, this line was taken by HAW! 
    ...
    ## OOps HAW! This is DEVILISH !!!!!!!
    def initialize_network_optimizer_and_scheduler(self):

        print("[HAW] Hmmm, this function should not be called. Please initialize network manually.")
    ...
    def process_plans(self, plans):
        ...
        # here comes the patch_size. I need this...
    ...
    def preprocess_patient(self, input_files):
        ...
        :return:
        """
        from uuunet.preprocessing.preprocessing import GenericPreprocessor, PreprocessorFor2D
        if self.threeD:
    ...
    def predict_preprocessed_data_return_softmax(self, data, do_mirroring, num_repeats, use_train_mode, batch_size,
                                                 mirror_axes, tiled, tile_in_z, step, min_size, use_gaussian, data_type):
        """
        Don't use this. If you need softmax output, use preprocess_predict_nifti and set softmax_output_file.
        ### HAW WTF! you say not use this but you use it plently!!!
        :param data:
        :param do_mirroring:
        :param num_repeats:
        ...
        """
        #assert isinstance(self.network, (SegmentationNetwork, nn.DataParallel))
        print("### training/network_training/nnUNetTrainer.py 409 ###")
        print(f"### data_type: {data_type}, modality: {self.modality}  ###")
        ...
        return self.network.predict_3D(data, do_mirroring, num_repeats, use_train_mode, batch_size, mirror_axes,
                                       ...
                                       modality=self.modality)[2]
        """
        if data_type == '3d_fullres':
            return self.network.predict_3D(data, do_mirroring, num_repeats, use_train_mode, batch_size, mirror_axes,
                                           tiled, tile_in_z, step, min_size, use_gaussian=use_gaussian,
                                           pad_border_mode=self.inference_pad_border_mode,
                                           pad_kwargs=self.inference_pad_kwargs,
            ...
            return self.network.predict_2D(data, do_mirroring, num_repeats, use_train_mode, batch_size, mirror_axes,
                                           tiled, tile_in_z, step, min_size, use_gaussian=use_gaussian,
                                           pad_border_mode=self.inference_pad_border_mode,
                                           pad_kwargs=self.inference_pad_kwargs,
                                           modality=self.modality)[2]
    ...
    #######################
    # this is bad, but I never used it, right?
    ...
    def validate(self, do_mirroring=True, use_train_mode=False, tiled=True, step=2, save_softmax=True,
        ...
        print("[HAW] validate() is called, but I have not modified this, so pay attention")
        print("[HAW] I advise not to call this, so if you see this, there is a bug.")
