...
from uuunet.training.data_augmentation.pyramid_augmentations import MoveSegAsOneHotToData, \
    RemoveRandomConnectedComponentFromOneHotEncodingTransform, ApplyRandomBinaryOperatorTransform
from uuunet.training.data_augmentation.custom_transforms import Convert3DTo2DTransform, Convert2DTo3DTransform, \
    MaskTransform
...
if __name__ == "__main__":
    from uuunet.training.dataloading.dataset_loading import DataLoader2D, DataLoader3D, load_dataset
    from uuunet.paths import preprocessing_output_dir
    import os
    import pickle
    t = "Task02_Heart"
