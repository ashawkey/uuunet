...
import argparse
from uuunet.inference.predict import predict_from_folder
from uuunet.paths import default_plans_identifier, network_training_output_dir
...
if __name__ == "__main__":
    ...
    parser.add_argument('-M', '--modality', help="0=MR, 1=CT", type=int,
    ...
    output_folder_name = join(network_training_output_dir, args.model, args.task_name, args.nnunet_trainer + "__" + args.plans_identifier)
