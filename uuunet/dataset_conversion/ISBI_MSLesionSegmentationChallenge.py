...
if __name__ == "__main__":
    ...
    maybe_mkdir_p("/media/fabian/uuunet/Task35_ISBILesionSegmentation")
    save_pickle(splits, join("/media/fabian/uuunet/Task35_ISBILesionSegmentation", "splits_final.pkl"))
